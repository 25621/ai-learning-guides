...
A learned stand-in for the environment's rules: given the current state and an action, it predicts the next state (and usually the [reward](/shared/reward-function)) — written `f(s, a) → s′, r`. 
