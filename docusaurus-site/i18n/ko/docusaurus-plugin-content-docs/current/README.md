...
기초 개념부터 연구 수준의 이해에 이르기까지 강화학습을 마스터하기 위한 체계적인 가이드입니다.
...
| 단계 | 집중 분야 | 소요 기간 |
|-------|-------|----------|
| 1 | [기초 (Foundations)](#phase-1-기초-2-4주) | 2-4주 |
| 2 | [테이블 방식 (Tabular Methods)](#phase-2-테이블-방식-3-4주) | 3-4주 |
| 3 | [함수 근사 (Function Approximation)](#phase-3-함수-근사-3-4주) | 3-4주 |
| 4 | [정책 그래디언트 방법 (Policy Gradient Methods)](#phase-4-정책-그래디언트-방법-4-5주) | 4-5주 |
| 5 | [심화 주제 (Advanced Topics)](#phase-5-심화-주제-6-8주) | 6-8주 |
| 6 | [연구 수준 (Research-Level)](#phase-6-연구-수준-진행-중) | 진행 중 |
...
- [모델 기반 강화학습 (Model-Based RL)](#모델-기반-강화학습-model-based-rl)
- [다중 에이전트 강화학습 (Multi-Agent RL)](#다중-에이전트-강화학습-multi-agent-rl)
- [오프라인 강화학습 (Offline/Batch RL)](#오프라인-강화학습-offlinebatch-rl)
- [탐험 (Exploration)](#탐험-exploration)
- [계층적 강화학습 (Hierarchical RL)](#계층적-강화학습-hierarchical-rl)
- [RLHF (인간 피드백을 통한 강화학습)](#rlhf-인간-피드백을-통한-강화학습)
