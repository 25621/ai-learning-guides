...
| フェーズ | 焦点 | 期間 |
|-------|-------|----------|
| 1 | [基礎](#フェーズ-1-基礎-2-4週間) | 2-4週間 |
| 2 | [テーブル手法](#フェーズ-2-テーブル手法-3-4週間) | 3-4週間 |
| 3 | [関数近似](#フェーズ-3-関数近似-3-4週間) | 3-4週間 |
| 4 | [方策勾配法](#フェーズ-4-方策勾配法-4-5週間) | 4-5週間 |
| 5 | [高度なトピック](#フェーズ-5-高度なトピック-6-8週間) | 6-8週間 |
| 6 | [研究レベル](#フェーズ-6-研究レベル-継続的) | 継続的 |
...
## フェーズ 5: 高度なトピック (6-8週間)

興味に基づいて 2-3 の分野を選択してください。
- [モデルベース強化学習](#モデルベース強化学習)
- [マルチエージェント強化学習](#マルチエージェント強化学習)
- [オフライン/バッチ強化学習](#オフラインバッチ強化学習)
- [探索](#探索)
- [階層的強化学習](#階層的強化学習)
- [RLHF (人間からのフィードバックによる強化学習)](#rlhf-人間からのフィードバックによる強化学習)
