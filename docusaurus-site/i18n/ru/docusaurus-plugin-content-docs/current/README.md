...
|-------|-------|----------|
| 1 | [Основы](#этап-1-основы-2-4-недели) | 2-4 недели |
| 2 | [Табличные методы](#этап-2-табличные-методы-3-4-недели) | 3-4 недели |
| 3 | [Аппроксимация функций](#этап-3-аппроксимация-функций-3-4-недели) | 3-4 недели |
| 4 | [Методы градиента политики](#этап-4-методы-градиента-политики-4-5-недель) | 4-5 недель |
| 5 | [Продвинутые темы](#этап-5-продвинутые-темы-6-8-недель) | 6-8 недель |
| 6 | [Исследовательский уровень](#этап-6-исследовательский-уровень-постоянно) | Постоянно |
...
## Этап 2: Табличные методы (3-4 недели)
...
## Этап 3: Аппроксимация функций (3-4 недели)
...
## Этап 4: Методы градиента политики (4-5 недель)
...
- [RL на основе моделей](#rl-на-основе-моделей)
- [Мультиагентный RL](#мультиагентный-rl)
- [Офлайн/Пакетный RL](#офлайнпакетный-rl)
- [Исследование](#исследование)
- [Иерархический RL](#иерархический-rl)
- [RLHF (RL на основе обратной связи от человека)](#rlhf-rl-на-основе-обратной-связи-от-человека)
...
### RLHF (RL на основе обратной связи от человека)
...
## Этап 6: Исследовательский уровень (Постоянно)
