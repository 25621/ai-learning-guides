...
[Triton Inference Server](/shared/glossary/#triton-inference-server) is NVIDIA's production server for hosting models. It loads your model, exposes it over HTTP, and handles batching and multiple model versions, so clients can send inputs and get predictions back over the network.
