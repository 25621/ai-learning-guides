"""Minimal CPU-only StyleGAN2 ops (native-fallback paths only, no CUDA JIT compile).
Derived from rosinality/stylegan2-pytorch (MIT License, Kim Seonghyeon).
"""
import torch
...
class conv2d_gradfix:
    ...
    def conv_transpose2d(input, weight, bias=None, stride=1, padding=0, output_padding=0, groups=1, dilation=1):
        return F.conv_transpose2d(input, weight, bias=bias, stride=stride, padding=padding,
