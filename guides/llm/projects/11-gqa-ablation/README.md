...
Multi-head attention gives every query [head](/shared/glossary/#heads) its own keys and values; [Multi-Query Attention (MQA)](/shared/glossary/#mqa) shares a single key/value head across all of them; [Grouped-Query Attention (GQA)](/shared/glossary/#gqa) sits in between. Fewer key/value heads means a smaller [KV cache](/shared/glossary/#kv-cache), at some cost to quality.
