...
## The Big Idea: Working in Chapters, Not Word by Word {#the-big-idea-working-in-chapters-not-word-by-word}
...
## What Is a "Flat" Agent? {#what-is-a-flat-agent}
...
## A Day in the Life of an Option-Critic Agent {#a-day-in-the-life-of-an-option-critic-agent}
